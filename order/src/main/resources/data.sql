 INSERT INTO `microservices`.`order_table` (created, user_id) VALUES (CURRENT_TIMESTAMP, 1);
 INSERT INTO `microservices`.`order_table` (created, user_id) VALUES (CURRENT_TIMESTAMP, 2);
 INSERT INTO `microservices`.`order_table` (created, user_id) VALUES (CURRENT_TIMESTAMP, 1);
